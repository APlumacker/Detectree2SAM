...
detectree_top <- st_join(tree_detectree_plot, plots_filtered_top20, join = st_intersects)
SAM_top       <- st_join(tree_SAM_plot, plots_filtered_top20, join = st_intersects)
d2s_top       <- st_join(tree_d2s_plot, plots_filtered_top20, join = st_intersects)
...
# Jointure spatiale pour récupérer l'attribut 'Nom' des parcelles
tree_detectree_plot_density  <- st_join(tree_detectree_plot, plots_filtered_top20, join = st_intersects)
tree_SAM_plot_density        <- st_join(tree_SAM_plot, plots_filtered_top20, join = st_intersects)
tree_d2s_plot_density        <- st_join(tree_d2s_plot, plots_filtered_top20, join = st_intersects)
